...
import { validateEmail, validateName, validatePassword } from '../../utils/validators/Validator';
          ...
          <div className={styles.cardContainer}>
            <Card>
              ...
              <form className={styles.form}>
                <Input name="Full name" type="text" placeholder="John Doe" error={nameError} 
                onChange={(e) => {
                ...
                <Input
                  ...
                  value={email}
                />
                <Input name="Password" type="password" placeholder="••••••" error={passwordError}
                onChange={(e) => {
